...
const JourneyScreen = () => {
  ...
  const handleBookingSubmit = () => {
    ...
    Alert.alert(
      "Booking Submitted!",
      `You have booked a trip from ${selectedJourney.from} → ${selectedJourney.to} on ${formData.date.toDateString()} for ${formData.passengers} passenger(s). We will contact you at ${formData.phone} for confirmation.`
    );
    setModalVisible(false);
